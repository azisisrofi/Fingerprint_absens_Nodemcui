...
const char *ssid = "PPTIK";  //ENTER YOUR WIFI SETTINGS
const char *password = "dibatasin";
//const int relayPin = D0; 
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.17.5/biometricattendance/getdata.php"; //computer IP or the server domain
